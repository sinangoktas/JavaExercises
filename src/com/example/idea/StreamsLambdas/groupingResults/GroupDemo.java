package com.example.idea.StreamsLambdas.groupingResults;
...
public class GroupDemo
{
   public static void main(String[] args)
   {
      ...
      Map<String, Set<String>> groupOfSets = Stream.of(words)
         .collect(Collectors.groupingBy(w -> w.substring(0, 1), // The function for extracting the keys
      ...
      Map<String, Optional<String>> groupLongest = Stream.of(words)
         .collect(
            Collectors.groupingBy(
               ...
               Collectors.maxBy(
                  (v, w) -> v.length() - w.length()))); //Comparator.comparingInt(String::length)
